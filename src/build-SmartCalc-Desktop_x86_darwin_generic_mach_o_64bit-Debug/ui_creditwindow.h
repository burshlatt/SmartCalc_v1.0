...
"}"));
        ...
        label->setFont(font);
        lineEdit = new QLineEdit(CreditWindow);
        lineEdit->setObjectName("lineEdit");
        lineEdit->setGeometry(QRect(175, 35, 130, 35));
        label_2 = new QLabel(CreditWindow);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(5, 85, 170, 35));
        label_2->setFont(font);
        lineEdit_2 = new QLineEdit(CreditWindow);
        lineEdit_2->setObjectName("lineEdit_2");
        lineEdit_2->setGeometry(QRect(175, 85, 130, 35));
        label_3 = new QLabel(CreditWindow);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(5, 135, 170, 35));
        label_3->setFont(font);
        lineEdit_3 = new QLineEdit(CreditWindow);
        lineEdit_3->setObjectName("lineEdit_3");
        lineEdit_3->setGeometry(QRect(175, 135, 130, 35));
        label_4 = new QLabel(CreditWindow);
        label_4->setObjectName("label_4");
        label_4->setGeometry(QRect(5, 202, 210, 35));
        label_4->setFont(font);
        radioButton = new QRadioButton(CreditWindow);
        radioButton->setObjectName("radioButton");
        radioButton->setGeometry(QRect(230, 185, 120, 35));
        QFont font1;
        font1.setPointSize(14);
        radioButton->setFont(font1);
        radioButton_2 = new QRadioButton(CreditWindow);
        radioButton_2->setObjectName("radioButton_2");
        radioButton_2->setGeometry(QRect(230, 220, 175, 35));
        radioButton_2->setFont(font1);
        pushButton = new QPushButton(CreditWindow);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(175, 270, 130, 40));
...
"}"));
        pushButton_2 = new QPushButton(CreditWindow);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(0, 0, 240, 20));
...
"                                      stop: 0 #FF7832, stop: 1 #FF9739);\n"
"}"));
        pushButton_3 = new QPushButton(CreditWindow);
        pushButton_3->setObjectName("pushButton_3");
        pushButton_3->setGeometry(QRect(240, 0, 240, 20));
...
"}"));
        ...
        lineEdit_4 = new QLineEdit(CreditWindow);
        lineEdit_4->setObjectName("lineEdit_4");
        lineEdit_4->setGeometry(QRect(175, 430, 130, 35));
        ...
        lineEdit_5 = new QLineEdit(CreditWindow);
        lineEdit_5->setObjectName("lineEdit_5");
        lineEdit_5->setGeometry(QRect(175, 380, 130, 35));
        lineEdit_5->setReadOnly(true);
        lineEdit_6 = new QLineEdit(CreditWindow);
        lineEdit_6->setObjectName("lineEdit_6");
        lineEdit_6->setGeometry(QRect(175, 330, 130, 35));
    ...
    void retranslateUi(QDialog *CreditWindow)
    {
        ...
        radioButton->setText(QCoreApplication::translate("CreditWindow", "\320\220\320\275\320\275\321\203\320\270\321\202\320\265\321\202\320\275\321\213\320\265", nullptr));
        radioButton_2->setText(QCoreApplication::translate("CreditWindow", "\320\224\320\270\321\204\321\204\320\265\321\200\320\265\320\275\321\206\320\270\321\200\320\276\320\262\320\260\320\275\320\275\321\213\320\265", nullptr));
        ...
        pushButton_2->setText(QCoreApplication::translate("CreditWindow", "\320\232\320\260\320\273\321\214\320\272\321\203\320\273\321\217\321\202\320\276\321\200", nullptr));
        pushButton_3->setText(QCoreApplication::translate("CreditWindow", "\320\224\320\265\320\277\320\276\320\267\320\270\321\202\320\275\321\213\320\271 \320\272\320\260\320\273\321\214\320\272\321\203\320\273\321\217\321\202\320\276\321\200", nullptr));
