...
double annuity_credit(double sum, int term, int type, double percent, double *month_pay, double *overpay) {
    if (type == 2) {
        term *= 12;
    }
...
double differentiated_credit(double sum, int term, int type, double percent, double *f_payment, double *l_payment, double *overpay) {
